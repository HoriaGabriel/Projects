...
public class ClientView extends JFrame{
     ...
     */
    public String getProductNameTextField() { return productNameTextField.getText(); }
    ...
    private void initializeForm(JPanel panel) {
        ...
        JLabel introLabel = new JLabel("Client Operation");
        ...
        showProductButton.setBounds(10,400,120,30);

        backButton = new JButton("Return");
        backButton.setBounds(10,450,120,30);

        orderButton = new JButton("Order");
        orderButton.setBounds(10,500,120,30);

        showOrderButton = new JButton("Show2");
        showOrderButton.setBounds(10,600,120,30);

        addButton = new JButton("Add");
        addButton.setBounds(10,550,120,30);
    ...
    /**
     * The function initializes the actionListener of the showProductButton
    ...
    /**
     * The function initializes the actionListener of the showOrderButton
     * @param  actionListener the actionListener of the show order button
     */
    public void showOrderButtonListener(ActionListener actionListener){

        showOrderButton.addActionListener(actionListener);
    }
