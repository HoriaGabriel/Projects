...
@Component
public class DeleteMemberDashboard extends AppFrame{
    ...
    private void initializeListeners(){
        ...
        deleteMemberButton.addActionListener(e->{
            ...
            if(searchPerson(titlBookTextField.getText())!=null){
    ...
    private void initializeForm(JPanel panel) {
        ...
        JLabel introLabel = new JLabel("Write name of the member to be deleted");
        ...
        deleteMemberButton.setBounds(80,110,200,30);
